...
var o__27018__auto___30695 = (function (){var o__27018__auto__ = (function (){var o__27018__auto__ = Promise;
return (o__27018__auto__["resolve"]).call(o__27018__auto__);
})();
return (o__27018__auto__["then"]).call(o__27018__auto__,callback);
})();
(o__27018__auto___30695["catch"]).call(o__27018__auto___30695,devtools.async.rethrow_outside_promise);
...
var G__30687_30697 = Error;
var target__27024__auto___30698 = G__30687_30697;
if(cljs.core.truth_(target__27024__auto___30698)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__30687_30697)].join(''),"\n","target__27024__auto__"].join('')));
}

(target__27024__auto___30698["stackTraceLimit"] = Infinity);
