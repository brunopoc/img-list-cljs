...
var G__27199 = cljs.core.PersistentArrayMap.EMPTY;
var G__27200 = native_stack_trace;
var G__27201 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__27202 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__27199,G__27200,G__27201,G__27202) : cljs.stacktrace.parse_stacktrace.call(null,G__27199,G__27200,G__27201,G__27202));
});
...
var map__27207 = top_item;
var map__27207__$1 = (((((!((map__27207 == null))))?(((((map__27207.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__27207.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__27207):map__27207);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27207__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27207__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__27207__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e27206){var _e = e27206;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___27324 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5718__auto___27324)){
var seen_errors_27325 = temp__5718__auto___27324;
if(cljs.core.truth_(seen_errors_27325.has(self))){
} else {
seen_errors_27325.add(self);

var temp__5720__auto___27327 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5720__auto___27327)){
var sense_27328 = temp__5720__auto___27327;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_27328)].join('');
} else {
}
}
} else {
