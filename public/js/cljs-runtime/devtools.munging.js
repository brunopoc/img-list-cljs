...
var o29422 = temp__5718__auto__;
var temp__5718__auto____$1 = (o29422["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o29423 = temp__5718__auto____$1;
return (o29423["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27018__auto__ = f;
return (o__27018__auto__["toString"]).call(o__27018__auto__);
} else {
return "";
}
}catch (e29428){var _ = e29428;
return "";
}});
...
try{var o__27018__auto___29838 = t;
(o__27018__auto___29838["cljs$lang$ctorPrWriter"]).call(o__27018__auto___29838,t,writer);
}catch (e29438){var __29839 = e29438;
}
...
var char_code = (function (){var o__27018__auto__ = (new String(char$));
return (o__27018__auto__["charCodeAt"]).call(o__27018__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27018__auto__ = String;
return (o__27018__auto__["fromCharCode"]).call(o__27018__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29450 = num_code;
switch (G__29450) {
case (1):
return (185);
...
var o__27018__auto__ = String;
return (o__27018__auto__["fromCharCode"]).call(o__27018__auto__,superscript_code);
});
/**
...
}catch (e29481){var _e__27028__auto__ = e29481;
return false;
}})())){
...
var vec__29483 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29483,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o29513 = temp__5718__auto__;
var temp__5718__auto____$1 = (o29513["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o29514 = temp__5718__auto____$1;
return (o29514["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29517){
var vec__29518 = p__29517;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29518,(0),null);
...
var G__29859 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__29860 = cljs.core.butlast(remaining_tokens);
name_tokens = G__29859;
remaining_tokens = G__29860;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29515){
...
var vec__29552 = cljs.core.split_with((function (p1__29548_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__29548_SHARP_,"arity");
}),tokens);
...
var vec__29563 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29563,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29563,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__29862 = cljs.core.rest(remaining_tokens);
var G__29863 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__29862;
name_tokens = G__29863;
continue;
} else {
...
var vec__29570 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29570,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29570,(1),null);
var vec__29573 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29573,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29573,(1),null);
var vec__29576 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29576,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29576,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29576,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29576,(3),null);
...
var vec__29583 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29583,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29583,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29583,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29583,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29583,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29583,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__29588 = temp__5718__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29588,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29588,(1),null);
var vec__29591 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__29607 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__29607) : devtools.munging.parse_fn_info_deep.call(null,G__29607));
})()));
}
} else {
return fn_info;
...
var G__29898 = (arity + (1));
var G__29899 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29634){
var vec__29647 = p__29634;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29647,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29647,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__29655_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__29656_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29664){
var vec__29665 = p__29664;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29665,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29657){
var G__29658 = cljs.core.first(seq29657);
var seq29657__$1 = cljs.core.next(seq29657);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29658,seq29657__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29700__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29700__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29700__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__29700__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29701 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29701,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29701,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29701,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29701,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29701,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29701,(5),null);
...
var o__27018__auto__ = f;
return (o__27018__auto__["getBasis"]).call(o__27018__auto__);
});
/**
...
}catch (e29721){var _e__27028__auto__ = e29721;
...
var G__29981 = (obj[cljs.core.first(path)]);
var G__29982 = cljs.core.rest(path);
obj = G__29981;
path = G__29982;
continue;
} else {
...
return (function (accum,p__29769){
var vec__29770 = p__29769;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29770,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29770,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29773){
var vec__29774 = p__29773;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29774,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29774,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29774,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29821,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__29821,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__29821,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__29791_SHARP_){
return (obj[cljs.core.first(p1__29791_SHARP_)]);
});})(name,sorted_matches,vec__29821,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
