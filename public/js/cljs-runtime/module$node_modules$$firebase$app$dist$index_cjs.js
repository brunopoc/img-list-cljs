...
rawConfig||error("bad-app-name",{name:rawConfig+""});Object.prototype.hasOwnProperty.call(apps_,rawConfig)&&error("duplicate-app",{name:rawConfig});options=new FirebaseAppImpl(options,config,namespace);apps_[rawConfig]=options;callAppHooks(options,"create");return options},app:app,apps:null,Promise:Promise,SDK_VERSION:"5.9.0",INTERNAL:{registerService:function(name,createService,serviceProperties,appHook,allowMultipleInstances){factories[name]&&error("duplicate-service",{name:name});factories[name]=
...
"invalid-app-argument":"firebase.{$name}() takes either no argument or a Firebase App instance."});process=!1;try{process="[object process]"===Object.prototype.toString.call(global.process)}catch(e){}process&&console.warn('\nWarning: This is a browser-targeted Firebase bundle but it appears it is being\nrun in a Node environment.  If running in a Node environment, make sure you\nare using the bundle specified by the "main" field in package.json.\n\nIf you are using Webpack, you can specify "main" as the first item in\n"resolve.mainFields":\nhttps://webpack.js.org/configuration/resolve/#resolvemainfields\n\nIf using Rollup, use the rollup-plugin-node-resolve plugin and set "module"\nto false and "main" to true:\nhttps://github.com/rollup/rollup-plugin-node-resolve\n');
global=createFirebaseNamespace();exports.firebase=global;exports.default=global}
