...
instance.INTERNAL.registerService("database",function(app,unused,url){return RepoManager.getInstance().databaseFromApp(app,url)},{Reference:Reference,Query:Query,Database:Database$jscomp$0,enableLogging:enableLogging,INTERNAL:INTERNAL,ServerValue:ServerValue,TEST_ACCESS:TEST_ACCESS},null,!0);util.isNodeSdk()&&(module.exports=instance)}Object.defineProperty(exports,"__esModule",{value:!0});var firebase=function(ex){return ex&&"object"===typeof ex&&"default"in ex?ex["default"]:ex}(require("module$node_modules$$firebase$app$dist$index_cjs")),
tslib_1=require("module$node_modules$tslib$tslib"),util=require("module$node_modules$$firebase$util$dist$index_cjs"),logger$1=require("module$node_modules$$firebase$logger$dist$index_cjs"),DOMStorageWrapper=function(){function DOMStorageWrapper(domStorage_){this.domStorage_=domStorage_;this.prefix_="firebase:"}DOMStorageWrapper.prototype.set=function(key,value){null==value?this.domStorage_.removeItem(this.prefixedName_(key)):this.domStorage_.setItem(this.prefixedName_(key),util.stringify(value))};
...
"cache");domStorage.removeItem("firebase:sentinel");return new DOMStorageWrapper(domStorage)}}catch(e){}return new MemoryStorage},PersistentStorage=createStoragefor("localStorage"),SessionStorage=createStoragefor("sessionStorage"),logClient=new logger$1.Logger("@firebase/database"),LUIDGenerator=function(){var id=1;return function(){return id++}}(),sha1=function(str){str=util.stringToByteArray(str);var sha1=new util.Sha1;sha1.update(str);str=sha1.digest();return util.base64.encodeByteArray(str)},
buildLogMessage_=function(){for(var var_args=[],_i=0;_i<arguments.length;_i++)var_args[_i]=arguments[_i];_i="";for(var i=0;i<var_args.length;i++)_i=Array.isArray(var_args[i])||var_args[i]&&"object"===typeof var_args[i]&&"number"===typeof var_args[i].length?_i+buildLogMessage_.apply(null,var_args[i]):"object"===typeof var_args[i]?_i+util.stringify(var_args[i]):_i+var_args[i],_i+=" ";return _i},logger=null,firstLog_=!0,enableLogging=function(logger_,persistent){util.assert(!persistent||!0===logger_||
!1===logger_,"Can't turn on custom loggers persistently.");!0===logger_?(logClient.logLevel=logger$1.LogLevel.VERBOSE,logger=logClient.log.bind(logClient),persistent&&SessionStorage.set("logging_enabled",!0)):"function"===typeof logger_?logger=logger_:(logger=null,SessionStorage.remove("logging_enabled"))},log=function(){for(var var_args=[],_i=0;_i<arguments.length;_i++)var_args[_i]=arguments[_i];!0===firstLog_&&(firstLog_=!1,null===logger&&!0===SessionStorage.get("logging_enabled")&&enableLogging(!0));
logger&&(var_args=buildLogMessage_.apply(null,var_args),logger(var_args))},logWrapper=function(prefix){return function(){for(var var_args=[],_i=0;_i<arguments.length;_i++)var_args[_i]=arguments[_i];log.apply(void 0,[prefix].concat(var_args))}},error$jscomp$0=function(){for(var var_args=[],_i=0;_i<arguments.length;_i++)var_args[_i]=arguments[_i];var_args="FIREBASE INTERNAL ERROR: "+buildLogMessage_.apply(void 0,var_args);logClient.error(var_args)},fatal=function(){for(var var_args=[],_i=0;_i<arguments.length;_i++)var_args[_i]=
...
"/.lp?";else throw Error("Unknown connection type: "+type);this.needsQueryParam()&&(params.ns=this.namespace);var pairs=[];util.forEach(params,function(key,value){pairs.push(key+"\x3d"+value)});return type+pairs.join("\x26")};RepoInfo.prototype.toString=function(){var str=this.toURLString();this.persistenceKey&&(str+="\x3c"+this.persistenceKey+"\x3e");return str};RepoInfo.prototype.toURLString=function(){return(this.secure?"https://":"http://")+this.host};return RepoInfo}(),parseRepoInfo=function(dataURL){var JSCompiler_object_inline_host_1252,
JSCompiler_object_inline_domain_1254,JSCompiler_object_inline_subdomain_1255,dataURL$jscomp$0=dataURL;var JSCompiler_object_inline_pathString_1258=JSCompiler_object_inline_subdomain_1255=JSCompiler_object_inline_domain_1254=JSCompiler_object_inline_host_1252="";var JSCompiler_object_inline_secure_1256=!0;dataURL="https";if("string"===typeof dataURL$jscomp$0){var colonInd=dataURL$jscomp$0.indexOf("//");0<=colonInd&&(dataURL=dataURL$jscomp$0.substring(0,colonInd-1),dataURL$jscomp$0=dataURL$jscomp$0.substring(colonInd+
2));colonInd=dataURL$jscomp$0.indexOf("/");-1===colonInd&&(colonInd=dataURL$jscomp$0.length);var questionMarkInd=dataURL$jscomp$0.indexOf("?");-1===questionMarkInd&&(questionMarkInd=dataURL$jscomp$0.length);JSCompiler_object_inline_host_1252=dataURL$jscomp$0.substring(0,Math.min(colonInd,questionMarkInd));if(colonInd<questionMarkInd){JSCompiler_object_inline_pathString_1258="";colonInd=dataURL$jscomp$0.substring(colonInd,questionMarkInd).split("/");for(var i=0;i<colonInd.length;i++)if(0<colonInd[i].length){var piece=
colonInd[i];try{piece=decodeURIComponent(piece.replace(/\+/g," "))}catch(e){}JSCompiler_object_inline_pathString_1258+="/"+piece}}colonInd=dataURL$jscomp$0.substring(Math.min(dataURL$jscomp$0.length,questionMarkInd));questionMarkInd={};"?"===colonInd.charAt(0)&&(colonInd=colonInd.substring(1));i=0;for(piece=colonInd.split("\x26");i<piece.length;i++){var segment=piece[i];if(0!==segment.length){var kv=segment.split("\x3d");2===kv.length?questionMarkInd[decodeURIComponent(kv[0])]=decodeURIComponent(kv[1]):
warn("Invalid query segment '"+segment+"' in query '"+colonInd+"'")}}colonInd=JSCompiler_object_inline_host_1252.indexOf(":");0<=colonInd?(JSCompiler_object_inline_secure_1256="https"===dataURL||"wss"===dataURL,parseInt(JSCompiler_object_inline_host_1252.substring(colonInd+1),10)):colonInd=dataURL$jscomp$0.length;dataURL$jscomp$0=JSCompiler_object_inline_host_1252.split(".");3===dataURL$jscomp$0.length?(JSCompiler_object_inline_domain_1254=dataURL$jscomp$0[1],JSCompiler_object_inline_subdomain_1255=
dataURL$jscomp$0[0].toLowerCase()):2===dataURL$jscomp$0.length?JSCompiler_object_inline_domain_1254=dataURL$jscomp$0[0]:"localhost"===dataURL$jscomp$0[0].slice(0,colonInd).toLowerCase()&&(JSCompiler_object_inline_domain_1254="localhost");""===JSCompiler_object_inline_subdomain_1255&&"ns"in questionMarkInd&&(JSCompiler_object_inline_subdomain_1255=questionMarkInd.ns)}"firebase"===JSCompiler_object_inline_domain_1254&&fatal(JSCompiler_object_inline_host_1252+" is no longer supported. Please use \x3cYOUR FIREBASE\x3e.firebaseio.com instead");
JSCompiler_object_inline_subdomain_1255&&"undefined"!=JSCompiler_object_inline_subdomain_1255||"localhost"===JSCompiler_object_inline_domain_1254||fatal("Cannot parse Firebase url. Please use https://\x3cYOUR FIREBASE\x3e.firebaseio.com");JSCompiler_object_inline_secure_1256||"undefined"!==typeof window&&window.location&&window.location.protocol&&-1!==window.location.protocol.indexOf("https:")&&warn("Insecure Firebase access from a secure page. Please use https in calls to new Firebase().");return{repoInfo:new RepoInfo(JSCompiler_object_inline_host_1252,
JSCompiler_object_inline_secure_1256,JSCompiler_object_inline_subdomain_1255,"ws"===dataURL||"wss"===dataURL),path:new Path(JSCompiler_object_inline_pathString_1258)}},INVALID_KEY_REGEX_=/[\[\].#$\/\u0000-\u001F\u007F]/,INVALID_PATH_REGEX_=/[\[\].#$\u0000-\u001F\u007F]/,isValidKey=function(key){return"string"===typeof key&&0!==key.length&&!INVALID_KEY_REGEX_.test(key)},isValidPathString=function(pathString){return"string"===typeof pathString&&0!==pathString.length&&!INVALID_PATH_REGEX_.test(pathString)},
...
[]}EventList.prototype.add=function(eventData){this.events_.push(eventData)};EventList.prototype.raise=function(){for(var i=0;i<this.events_.length;i++){var eventData=this.events_[i];if(null!==eventData){this.events_[i]=null;var eventFn=eventData.getEventRunner();logger&&log("event: "+eventData.toString());exceptionGuard(eventFn)}}};EventList.prototype.getPath=function(){return this.path_};return EventList}(),EventEmitter=function(){function EventEmitter(allowedEvents_){this.allowedEvents_=allowedEvents_;
...
thisListen;query=query.getQueryParams().toRestQueryStringParameters();this.restRequest_(pathString+".json",query,function(error,result){404===error&&(error=result=null);if(null===error)_this.onDataUpdate_(pathString,result,!1,tag);util.safeGet(_this.listens_,listenId)===thisListen&&onComplete(error?401==error?"permission_denied":"rest_error:"+error:"ok",null)})};ReadonlyRestClient.prototype.unlisten=function(query,tag){query=ReadonlyRestClient.getListenId_(query,tag);delete this.listens_[query]};
...
pathString+"?ns\x3d"+_this.repoInfo_.namespace+util.querystring(queryStringParameters);_this.log_("Sending REST request for "+url);var xhr=new XMLHttpRequest;xhr.onreadystatechange=function(){if(callback&&4===xhr.readyState){_this.log_("REST Response for "+url+" received. status:",xhr.status,"response:",xhr.responseText);var res=null;if(200<=xhr.status&&300>xhr.status){try{res=util.jsonEval(xhr.responseText)}catch(e){warn("Failed to parse JSON response for "+url+": "+xhr.responseText)}callback(null,
res)}else 401!==xhr.status&&404!==xhr.status&&warn("Got unsuccessful REST response for "+url+" Status: "+xhr.status),callback(xhr.status);callback=null}};xhr.open("GET",url,!0);xhr.send()})};return ReadonlyRestClient}(ServerActions),Repo=function(){function Repo(repoInfo_,forceRestClient,app){var _this=this;this.repoInfo_=repoInfo_;this.app=app;this.dataUpdateCount=0;this.statsListener_=null;this.eventQueue_=new EventQueue;this.nextWriteId_=1;this.interceptServerDataCallback_=null;this.onDisconnect_=
new SparseSnapshotTree;this.persistentConnection_=null;var authTokenProvider=new AuthTokenProvider(app);this.stats_=StatsManager.getCollection(repoInfo_);if(forceRestClient||0<=("object"===typeof window&&window.navigator&&window.navigator.userAgent||"").search(/googlebot|google webmaster tools|bingbot|yahoo! slurp|baiduspider|yandexbot|duckduckbot/i))this.server_=new ReadonlyRestClient(this.repoInfo_,this.onDataUpdate_.bind(this),authTokenProvider),setTimeout(this.onConnectStatus_.bind(this,!0),0);
else{forceRestClient=app.options.databaseAuthVariableOverride;if("undefined"!==typeof forceRestClient&&null!==forceRestClient){if("object"!==typeof forceRestClient)throw Error("Only objects are supported for option databaseAuthVariableOverride");try{util.stringify(forceRestClient)}catch(e){throw Error("Invalid authOverride provided: "+e);}}this.server_=this.persistentConnection_=new PersistentConnection(this.repoInfo_,this.onDataUpdate_.bind(this),this.onConnectStatus_.bind(this),this.onServerInfoUpdate_.bind(this),
authTokenProvider,forceRestClient)}authTokenProvider.addTokenChangeListener(function(token){_this.server_.refreshAuthToken(token)});this.statsReporter_=StatsManager.getOrCreateReporter(repoInfo_,function(){return new StatsReporter(_this.stats_,_this.server_)});this.transactions_init_();this.infoData_=new SnapshotHolder;this.infoSyncTree_=new SyncTree({startListening:function(query,tag,currentHashFn,onComplete){tag=[];currentHashFn=_this.infoData_.getNode(query.path);currentHashFn.isEmpty()||(tag=
_this.infoSyncTree_.applyServerOverwrite(query.path,currentHashFn),setTimeout(function(){onComplete("ok")},0));return tag},stopListening:function(){}});this.updateInfo_("connected",!1);this.serverSyncTree_=new SyncTree({startListening:function(query,tag,currentHashFn,onComplete){_this.server_.listen(query,currentHashFn,tag,function(status,data){status=onComplete(status,data);_this.eventQueue_.raiseEventsForChangedPath(query.path,status)});return[]},stopListening:function(query,tag){_this.server_.unlisten(query,
tag)}})}Repo.prototype.toString=function(){return(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host};Repo.prototype.name=function(){return this.repoInfo_.namespace};Repo.prototype.serverTime=function(){var offset=this.infoData_.getNode(new Path(".info/serverTimeOffset")).val()||0;return(new Date).getTime()+offset};Repo.prototype.generateServerValues=function(){var values={timestamp:this.serverTime()};values=values||{};values.timestamp=values.timestamp||(new Date).getTime();return values};
Repo.prototype.onDataUpdate_=function(pathString,data,isMerge,tag){this.dataUpdateCount++;var path=new Path(pathString);data=this.interceptServerDataCallback_?this.interceptServerDataCallback_(pathString,data):data;pathString=[];tag?isMerge?(data=util.map(data,function(raw){return nodeFromJSON$1(raw)}),pathString=this.serverSyncTree_.applyTaggedQueryMerge(path,data,tag)):(data=nodeFromJSON$1(data),pathString=this.serverSyncTree_.applyTaggedQueryOverwrite(path,data,tag)):isMerge?(tag=util.map(data,
function(raw){return nodeFromJSON$1(raw)}),pathString=this.serverSyncTree_.applyServerMerge(path,tag)):(tag=nodeFromJSON$1(data),pathString=this.serverSyncTree_.applyServerOverwrite(path,tag));tag=path;0<pathString.length&&(tag=this.rerunTransactions_(path));this.eventQueue_.raiseEventsForChangedPath(tag,pathString)};Repo.prototype.interceptServerData_=function(callback){this.interceptServerDataCallback_=callback};Repo.prototype.onConnectStatus_=function(connectStatus){this.updateInfo_("connected",
connectStatus);!1===connectStatus&&this.runOnDisconnectEvents_()};Repo.prototype.onServerInfoUpdate_=function(updates){var _this=this;each(updates,function(value,key){_this.updateInfo_(key,value)})};Repo.prototype.updateInfo_=function(pathString,value){pathString=new Path("/.info/"+pathString);value=nodeFromJSON$1(value);this.infoData_.updateSnapshot(pathString,value);value=this.infoSyncTree_.applyServerOverwrite(pathString,value);this.eventQueue_.raiseEventsForChangedPath(pathString,value)};Repo.prototype.getNextWriteId_=
function(){return this.nextWriteId_++};Repo.prototype.setWithPriority=function(path,newVal,newPriority,onComplete){var _this=this;this.log_("set",{path:path.toString(),value:newVal,priority:newPriority});var serverValues=this.generateServerValues();newVal=nodeFromJSON$1(newVal,newPriority);serverValues=resolveDeferredValueSnapshot(newVal,serverValues);var writeId=this.getNextWriteId_();serverValues=this.serverSyncTree_.applyUserOverwrite(path,serverValues,writeId,!0);this.eventQueue_.queueEvents(serverValues);
this.server_.put(path.toString(),newVal.val(!0),function(status,errorReason){var success="ok"===status;success||warn("set at "+path+" failed: "+status);success=_this.serverSyncTree_.ackUserWrite(writeId,!success);_this.eventQueue_.raiseEventsForChangedPath(path,success);_this.callOnCompleteCallback(onComplete,status,errorReason)});serverValues=this.abortTransactions_(path);this.rerunTransactions_(serverValues);this.eventQueue_.raiseEventsForChangedPath(serverValues,[])};Repo.prototype.update=function(path,
childrenToMerge,onComplete){var _this=this;this.log_("update",{path:path.toString(),value:childrenToMerge});var empty=!0,serverValues=this.generateServerValues(),changedChildren={};util.forEach(childrenToMerge,function(changedKey,changedValue){empty=!1;changedValue=nodeFromJSON$1(changedValue);changedChildren[changedKey]=resolveDeferredValueSnapshot(changedValue,serverValues)});if(empty)log("update() called with empty data.  Don't do anything."),this.callOnCompleteCallback(onComplete,"ok");else{var writeId_1=
this.getNextWriteId_(),events=this.serverSyncTree_.applyUserMerge(path,changedChildren,writeId_1);this.eventQueue_.queueEvents(events);this.server_.merge(path.toString(),childrenToMerge,function(status,errorReason){var success="ok"===status;success||warn("update at "+path+" failed: "+status);success=_this.serverSyncTree_.ackUserWrite(writeId_1,!success);var affectedPath=0<success.length?_this.rerunTransactions_(path):path;_this.eventQueue_.raiseEventsForChangedPath(affectedPath,success);_this.callOnCompleteCallback(onComplete,
status,errorReason)});util.forEach(childrenToMerge,function(changedPath){changedPath=_this.abortTransactions_(path.child(changedPath));_this.rerunTransactions_(changedPath)});this.eventQueue_.raiseEventsForChangedPath(path,[])}};Repo.prototype.runOnDisconnectEvents_=function(){var _this=this;this.log_("onDisconnectEvents");var serverValues=this.generateServerValues(),events=[];resolveDeferredValueTree(this.onDisconnect_,serverValues).forEachTree(Path.Empty,function(path,snap){events=events.concat(_this.serverSyncTree_.applyServerOverwrite(path,
snap));path=_this.abortTransactions_(path);_this.rerunTransactions_(path)});this.onDisconnect_=new SparseSnapshotTree;this.eventQueue_.raiseEventsForChangedPath(Path.Empty,events)};Repo.prototype.onDisconnectCancel=function(path,onComplete){var _this=this;this.server_.onDisconnectCancel(path.toString(),function(status,errorReason){"ok"===status&&_this.onDisconnect_.forget(path);_this.callOnCompleteCallback(onComplete,status,errorReason)})};Repo.prototype.onDisconnectSet=function(path,value,onComplete){var _this=
this,newNode=nodeFromJSON$1(value);this.server_.onDisconnectPut(path.toString(),newNode.val(!0),function(status,errorReason){"ok"===status&&_this.onDisconnect_.remember(path,newNode);_this.callOnCompleteCallback(onComplete,status,errorReason)})};Repo.prototype.onDisconnectSetWithPriority=function(path,value,priority,onComplete){var _this=this,newNode=nodeFromJSON$1(value,priority);this.server_.onDisconnectPut(path.toString(),newNode.val(!0),function(status,errorReason){"ok"===status&&_this.onDisconnect_.remember(path,
newNode);_this.callOnCompleteCallback(onComplete,status,errorReason)})};Repo.prototype.onDisconnectUpdate=function(path,childrenToMerge,onComplete){var _this=this;if(util.isEmpty(childrenToMerge))log("onDisconnect().update() called with empty data.  Don't do anything."),this.callOnCompleteCallback(onComplete,"ok");else this.server_.onDisconnectMerge(path.toString(),childrenToMerge,function(status,errorReason){"ok"===status&&util.forEach(childrenToMerge,function(childName,childNode){childNode=nodeFromJSON$1(childNode);
_this.onDisconnect_.remember(path.child(childName),childNode)});_this.callOnCompleteCallback(onComplete,status,errorReason)})};Repo.prototype.addEventCallbackForQuery=function(query,eventRegistration){eventRegistration=".info"===query.path.getFront()?this.infoSyncTree_.addEventRegistration(query,eventRegistration):this.serverSyncTree_.addEventRegistration(query,eventRegistration);this.eventQueue_.raiseEventsAtPath(query.path,eventRegistration)};Repo.prototype.removeEventCallbackForQuery=function(query,
eventRegistration){eventRegistration=".info"===query.path.getFront()?this.infoSyncTree_.removeEventRegistration(query,eventRegistration):this.serverSyncTree_.removeEventRegistration(query,eventRegistration);this.eventQueue_.raiseEventsAtPath(query.path,eventRegistration)};Repo.prototype.interrupt=function(){this.persistentConnection_&&this.persistentConnection_.interrupt("repo_interrupt")};Repo.prototype.resume=function(){this.persistentConnection_&&this.persistentConnection_.resume("repo_interrupt")};
Repo.prototype.stats=function(showDelta){void 0===showDelta&&(showDelta=!1);if("undefined"!==typeof console){showDelta?(this.statsListener_||(this.statsListener_=new StatsListener(this.stats_)),showDelta=this.statsListener_.get()):showDelta=this.stats_.get();var longestName=Object.keys(showDelta).reduce(function(previousValue,currentValue){return Math.max(currentValue.length,previousValue)},0);util.forEach(showDelta,function(stat,value){for(var i=stat.length;i<longestName+2;i++)stat+=" ";console.log(stat+
value)})}};Repo.prototype.statsIncrementCounter=function(metric){this.stats_.incrementCounter(metric);this.statsReporter_.includeStat(metric)};Repo.prototype.log_=function(){for(var var_args=[],_i=0;_i<arguments.length;_i++)var_args[_i]=arguments[_i];_i="";this.persistentConnection_&&(_i=this.persistentConnection_.id+":");log.apply(void 0,[_i].concat(var_args))};Repo.prototype.callOnCompleteCallback=function(callback,status,errorReason){callback&&exceptionGuard(function(){if("ok"==status)callback(null);
else{var code=(status||"error").toUpperCase(),message=code;errorReason&&(message+=": "+errorReason);message=Error(message);message.code=code;callback(message)}})};Object.defineProperty(Repo.prototype,"database",{get:function(){return this.__database||(this.__database=new Database$jscomp$0(this))},enumerable:!0,configurable:!0});return Repo}(),RangedFilter=function(){function RangedFilter(params){this.indexedFilter_=new IndexedFilter(params.getIndex());this.index_=params.getIndex();this.startPost_=
RangedFilter.getStartPost_(params);this.endPost_=RangedFilter.getEndPost_(params)}RangedFilter.prototype.getStartPost=function(){return this.startPost_};RangedFilter.prototype.getEndPost=function(){return this.endPost_};RangedFilter.prototype.matches=function(node){return 0>=this.index_.compare(this.getStartPost(),node)&&0>=this.index_.compare(node,this.getEndPost())};RangedFilter.prototype.updateChild=function(snap,key,newChild,affectedPath,source,optChangeAccumulator){this.matches(new NamedNode(key,
newChild))||(newChild=ChildrenNode.EMPTY_NODE);return this.indexedFilter_.updateChild(snap,key,newChild,affectedPath,source,optChangeAccumulator)};RangedFilter.prototype.updateFullNode=function(oldSnap,newSnap,optChangeAccumulator){newSnap.isLeafNode()&&(newSnap=ChildrenNode.EMPTY_NODE);var filtered=newSnap.withIndex(this.index_);filtered=filtered.updatePriority(ChildrenNode.EMPTY_NODE);var self=this;newSnap.forEachChild(PRIORITY_INDEX,function(key,childNode){self.matches(new NamedNode(key,childNode))||
(filtered=filtered.updateImmediateChild(key,ChildrenNode.EMPTY_NODE))});return this.indexedFilter_.updateFullNode(oldSnap,filtered,optChangeAccumulator)};RangedFilter.prototype.updatePriority=function(oldSnap,newPriority){return oldSnap};RangedFilter.prototype.filtersNodes=function(){return!0};RangedFilter.prototype.getIndexedFilter=function(){return this.indexedFilter_};RangedFilter.prototype.getIndex=function(){return this.index_};RangedFilter.getStartPost_=function(params){if(params.hasStart()){var startName=
params.getIndexStartName();return params.getIndex().makePost(params.getIndexStartValue(),startName)}return params.getIndex().minPost()};RangedFilter.getEndPost_=function(params){if(params.hasEnd()){var endName=params.getIndexEndName();return params.getIndex().makePost(params.getIndexEndValue(),endName)}return params.getIndex().maxPost()};return RangedFilter}(),LimitedFilter=function(){function LimitedFilter(params){this.rangedFilter_=new RangedFilter(params);this.index_=params.getIndex();this.limit_=
params.getLimit();this.reverse_=!params.isViewFromLeft()}LimitedFilter.prototype.updateChild=function(snap,key,newChild,affectedPath,source,optChangeAccumulator){this.rangedFilter_.matches(new NamedNode(key,newChild))||(newChild=ChildrenNode.EMPTY_NODE);return snap.getImmediateChild(key).equals(newChild)?snap:snap.numChildren()<this.limit_?this.rangedFilter_.getIndexedFilter().updateChild(snap,key,newChild,affectedPath,source,optChangeAccumulator):this.fullLimitUpdateChild_(snap,key,newChild,source,
optChangeAccumulator)};LimitedFilter.prototype.updateFullNode=function(oldSnap,newSnap,optChangeAccumulator){if(newSnap.isLeafNode()||newSnap.isEmpty())var filtered=ChildrenNode.EMPTY_NODE.withIndex(this.index_);else if(2*this.limit_<newSnap.numChildren()&&newSnap.isIndexed(this.index_)){filtered=ChildrenNode.EMPTY_NODE.withIndex(this.index_);var iterator=void 0;iterator=this.reverse_?newSnap.getReverseIteratorFrom(this.rangedFilter_.getEndPost(),this.index_):newSnap.getIteratorFrom(this.rangedFilter_.getStartPost(),
this.index_);for(newSnap=0;iterator.hasNext()&&newSnap<this.limit_;){var next=iterator.getNext(),inRange=void 0;if(inRange=this.reverse_?0>=this.index_.compare(this.rangedFilter_.getStartPost(),next):0>=this.index_.compare(next,this.rangedFilter_.getEndPost()))filtered=filtered.updateImmediateChild(next.name,next.node),newSnap++;else break}}else{filtered=newSnap.withIndex(this.index_);filtered=filtered.updatePriority(ChildrenNode.EMPTY_NODE);var startPost=void 0,endPost=void 0,cmp=void 0;iterator=
void 0;if(this.reverse_){iterator=filtered.getReverseIterator(this.index_);startPost=this.rangedFilter_.getEndPost();endPost=this.rangedFilter_.getStartPost();var indexCompare_1=this.index_.getCompare();cmp=function(a,b){return indexCompare_1(b,a)}}else iterator=filtered.getIterator(this.index_),startPost=this.rangedFilter_.getStartPost(),endPost=this.rangedFilter_.getEndPost(),cmp=this.index_.getCompare();newSnap=0;for(var foundStartPost=!1;iterator.hasNext();)next=iterator.getNext(),!foundStartPost&&
0>=cmp(startPost,next)&&(foundStartPost=!0),(inRange=foundStartPost&&newSnap<this.limit_&&0>=cmp(next,endPost))?newSnap++:filtered=filtered.updateImmediateChild(next.name,ChildrenNode.EMPTY_NODE)}return this.rangedFilter_.getIndexedFilter().updateFullNode(oldSnap,filtered,optChangeAccumulator)};LimitedFilter.prototype.updatePriority=function(oldSnap,newPriority){return oldSnap};LimitedFilter.prototype.filtersNodes=function(){return!0};LimitedFilter.prototype.getIndexedFilter=function(){return this.rangedFilter_.getIndexedFilter()};
LimitedFilter.prototype.getIndex=function(){return this.index_};LimitedFilter.prototype.fullLimitUpdateChild_=function(snap,childKey,childSnap,source,changeAccumulator){if(this.reverse_){var indexCmp_1=this.index_.getCompare();var cmp=function(a,b){return indexCmp_1(b,a)}}else cmp=this.index_.getCompare();util.assert(snap.numChildren()==this.limit_,"");var newChildNamedNode=new NamedNode(childKey,childSnap),windowBoundary=this.reverse_?snap.getFirstChild(this.index_):snap.getLastChild(this.index_),
inRange=this.rangedFilter_.matches(newChildNamedNode);if(snap.hasChild(childKey)){var oldChildSnap=snap.getImmediateChild(childKey);for(windowBoundary=source.getChildAfterChild(this.index_,windowBoundary,this.reverse_);null!=windowBoundary&&(windowBoundary.name==childKey||snap.hasChild(windowBoundary.name));)windowBoundary=source.getChildAfterChild(this.index_,windowBoundary,this.reverse_);source=null==windowBoundary?1:cmp(windowBoundary,newChildNamedNode);if(inRange&&!childSnap.isEmpty()&&0<=source)return null!=
changeAccumulator&&changeAccumulator.trackChildChange(Change.childChangedChange(childKey,childSnap,oldChildSnap)),snap.updateImmediateChild(childKey,childSnap);null!=changeAccumulator&&changeAccumulator.trackChildChange(Change.childRemovedChange(childKey,oldChildSnap));snap=snap.updateImmediateChild(childKey,ChildrenNode.EMPTY_NODE);return null!=windowBoundary&&this.rangedFilter_.matches(windowBoundary)?(null!=changeAccumulator&&changeAccumulator.trackChildChange(Change.childAddedChange(windowBoundary.name,
...
enumerable:!0,configurable:!0});Object.defineProperty(Reference.prototype,"key",{get:function(){return this.getKey()},enumerable:!0,configurable:!0});Object.defineProperty(Reference.prototype,"parent",{get:function(){return this.getParent()},enumerable:!0,configurable:!0});Object.defineProperty(Reference.prototype,"root",{get:function(){return this.getRoot()},enumerable:!0,configurable:!0});return Reference}(Query);Query.__referenceConstructor=Reference;SyncPoint.__referenceConstructor=Reference;
...
function(action,includeSelf){for(includeSelf=includeSelf?this:this.parent();null!==includeSelf;){if(action(includeSelf))return!0;includeSelf=includeSelf.parent()}return!1};Tree.prototype.forEachImmediateDescendantWithValue=function(action){this.forEachChild(function(child){null!==child.getValue()?action(child):child.forEachImmediateDescendantWithValue(action)})};Tree.prototype.path=function(){return new Path(null===this.parent_?this.name_:this.parent_.path()+"/"+this.name_)};Tree.prototype.name=function(){return this.name_};
Tree.prototype.parent=function(){return this.parent_};Tree.prototype.updateParents_=function(){null!==this.parent_&&this.parent_.updateChild_(this.name_,this)};Tree.prototype.updateChild_=function(childName,child){var childEmpty=child.isEmpty(),childExists=util.contains(this.node_.children,childName);childEmpty&&childExists?(delete this.node_.children[childName],this.node_.childCount--,this.updateParents_()):childEmpty||childExists||(this.node_.children[childName]=child.node_,this.node_.childCount++,
this.updateParents_())};return Tree}(),TransactionStatus;(function(TransactionStatus){TransactionStatus[TransactionStatus.RUN=0]="RUN";TransactionStatus[TransactionStatus.SENT=1]="SENT";TransactionStatus[TransactionStatus.COMPLETED=2]="COMPLETED";TransactionStatus[TransactionStatus.SENT_NEEDS_ABORT=3]="SENT_NEEDS_ABORT";TransactionStatus[TransactionStatus.NEEDS_ABORT=4]="NEEDS_ABORT"})(TransactionStatus||(TransactionStatus={}));Repo.MAX_TRANSACTION_RETRIES_=25;Repo.prototype.transactions_init_=function(){this.transactionQueueTree_=
new Tree};Repo.prototype.startTransaction=function(path,transactionUpdate,onComplete,applyLocally){this.log_("transaction on "+path);var valueCallback=function(){},watchRef=new Reference(this,path);watchRef.on("value",valueCallback);transactionUpdate={path:path,update:transactionUpdate,onComplete:onComplete,status:null,order:LUIDGenerator(),applyLocally:applyLocally,retryCount:0,unwatcher:function(){watchRef.off("value",valueCallback)},abortReason:null,currentWriteId:null,currentInputSnapshot:null,
currentOutputSnapshotRaw:null,currentOutputSnapshotResolved:null};onComplete=this.getLatestState_(path);transactionUpdate.currentInputSnapshot=onComplete;onComplete=transactionUpdate.update(onComplete.val());if(void 0===onComplete)transactionUpdate.unwatcher(),transactionUpdate.currentOutputSnapshotRaw=null,transactionUpdate.currentOutputSnapshotResolved=null,transactionUpdate.onComplete&&(path=new DataSnapshot(transactionUpdate.currentInputSnapshot,new Reference(this,transactionUpdate.path),PRIORITY_INDEX),
transactionUpdate.onComplete(null,!1,path));else{validateFirebaseData("transaction failed: Data returned ",onComplete,transactionUpdate.path);transactionUpdate.status=TransactionStatus.RUN;applyLocally=this.transactionQueueTree_.subTree(path);var nodeQueue=applyLocally.getValue()||[];nodeQueue.push(transactionUpdate);applyLocally.setValue(nodeQueue);nodeQueue=void 0;"object"===typeof onComplete&&null!==onComplete&&util.contains(onComplete,".priority")?(nodeQueue=util.safeGet(onComplete,".priority"),
util.assert(isValidPriority(nodeQueue),"Invalid priority returned by transaction. Priority must be a valid string, finite number, server value, or null.")):nodeQueue=(this.serverSyncTree_.calcCompleteEventCache(path)||ChildrenNode.EMPTY_NODE).getPriority().val();applyLocally=this.generateServerValues();onComplete=nodeFromJSON$1(onComplete,nodeQueue);applyLocally=resolveDeferredValueSnapshot(onComplete,applyLocally);transactionUpdate.currentOutputSnapshotRaw=onComplete;transactionUpdate.currentOutputSnapshotResolved=
applyLocally;transactionUpdate.currentWriteId=this.getNextWriteId_();transactionUpdate=this.serverSyncTree_.applyUserOverwrite(path,applyLocally,transactionUpdate.currentWriteId,transactionUpdate.applyLocally);this.eventQueue_.raiseEventsForChangedPath(path,transactionUpdate);this.sendReadyTransactions_()}};Repo.prototype.getLatestState_=function(path,excludeSets){return this.serverSyncTree_.calcCompleteEventCache(path,excludeSets)||ChildrenNode.EMPTY_NODE};Repo.prototype.sendReadyTransactions_=function(node){var _this=
this;void 0===node&&(node=this.transactionQueueTree_);node||this.pruneCompletedTransactionsBelowNode_(node);if(null!==node.getValue()){var queue=this.buildTransactionQueue_(node);util.assert(0<queue.length,"Sending zero length transaction queue");queue.every(function(transaction){return transaction.status===TransactionStatus.RUN})&&this.sendTransactionQueue_(node.path(),queue)}else node.hasChildren()&&node.forEachChild(function(childNode){_this.sendReadyTransactions_(childNode)})};Repo.prototype.sendTransactionQueue_=
function(path,queue){var _this=this,setsToIgnore=queue.map(function(txn){return txn.currentWriteId}),latestState=this.getLatestState_(path,setsToIgnore);setsToIgnore=latestState;latestState=latestState.hash();for(var i$jscomp$0=0;i$jscomp$0<queue.length;i$jscomp$0++){var txn=queue[i$jscomp$0];util.assert(txn.status===TransactionStatus.RUN,"tryToSendTransactionQueue_: items in queue should all be run.");txn.status=TransactionStatus.SENT;txn.retryCount++;var relativePath=Path.relativePath(path,txn.path);
setsToIgnore=setsToIgnore.updateChild(relativePath,txn.currentOutputSnapshotRaw)}setsToIgnore=setsToIgnore.val(!0);this.server_.put(path.toString(),setsToIgnore,function(status){_this.log_("transaction put response",{path:path.toString(),status:status});var events=[];if("ok"===status){status=[];for(var i=0;i<queue.length;i++){queue[i].status=TransactionStatus.COMPLETED;events=events.concat(_this.serverSyncTree_.ackUserWrite(queue[i].currentWriteId));if(queue[i].onComplete){var node=queue[i].currentOutputSnapshotResolved,
ref=new Reference(_this,queue[i].path);node=new DataSnapshot(node,ref,PRIORITY_INDEX);status.push(queue[i].onComplete.bind(null,null,!0,node))}queue[i].unwatcher()}_this.pruneCompletedTransactionsBelowNode_(_this.transactionQueueTree_.subTree(path));_this.sendReadyTransactions_();_this.eventQueue_.raiseEventsForChangedPath(path,events);for(i=0;i<status.length;i++)exceptionGuard(status[i])}else{if("datastale"===status)for(i=0;i<queue.length;i++)queue[i].status=queue[i].status===TransactionStatus.SENT_NEEDS_ABORT?
TransactionStatus.NEEDS_ABORT:TransactionStatus.RUN;else for(warn("transaction at "+path.toString()+" failed: "+status),i=0;i<queue.length;i++)queue[i].status=TransactionStatus.NEEDS_ABORT,queue[i].abortReason=status;_this.rerunTransactions_(path)}},latestState)};Repo.prototype.rerunTransactions_=function(changedPath){var rootMostTransactionNode=this.getAncestorTransactionNode_(changedPath);changedPath=rootMostTransactionNode.path();rootMostTransactionNode=this.buildTransactionQueue_(rootMostTransactionNode);
this.rerunTransactionQueue_(rootMostTransactionNode,changedPath);return changedPath};Repo.prototype.rerunTransactionQueue_=function(queue,path){if(0!==queue.length){for(var callbacks=[],events=[],setsToIgnore=queue.filter(function(q){return q.status===TransactionStatus.RUN}).map(function(q){return q.currentWriteId}),i=0;i<queue.length;i++){var transaction=queue[i],relativePath=Path.relativePath(path,transaction.path),abortTransaction=!1,abortReason=void 0;util.assert(null!==relativePath,"rerunTransactionsUnderNode_: relativePath should not be null.");
...
transaction.currentInputSnapshot=currentNode;var newData=queue[i].update(currentNode.val());void 0!==newData?(validateFirebaseData("transaction failed: Data returned ",newData,transaction.path),relativePath=nodeFromJSON$1(newData),"object"===typeof newData&&null!=newData&&util.contains(newData,".priority")||(relativePath=relativePath.updatePriority(currentNode.getPriority())),currentNode=transaction.currentWriteId,newData=this.generateServerValues(),newData=resolveDeferredValueSnapshot(relativePath,
newData),transaction.currentOutputSnapshotRaw=relativePath,transaction.currentOutputSnapshotResolved=newData,transaction.currentWriteId=this.getNextWriteId_(),setsToIgnore.splice(setsToIgnore.indexOf(currentNode),1),events=events.concat(this.serverSyncTree_.applyUserOverwrite(transaction.path,newData,transaction.currentWriteId,transaction.applyLocally)),events=events.concat(this.serverSyncTree_.ackUserWrite(currentNode,!0))):(abortTransaction=!0,abortReason="nodata",events=events.concat(this.serverSyncTree_.ackUserWrite(transaction.currentWriteId,
!0)))}this.eventQueue_.raiseEventsForChangedPath(path,events);events=[];abortTransaction&&(queue[i].status=TransactionStatus.COMPLETED,setTimeout(queue[i].unwatcher,0),queue[i].onComplete&&("nodata"===abortReason?(transaction=new Reference(this,queue[i].path),transaction=new DataSnapshot(queue[i].currentInputSnapshot,transaction,PRIORITY_INDEX),callbacks.push(queue[i].onComplete.bind(null,null,!1,transaction))):callbacks.push(queue[i].onComplete.bind(null,Error(abortReason),!1,null))))}this.pruneCompletedTransactionsBelowNode_(this.transactionQueueTree_);
