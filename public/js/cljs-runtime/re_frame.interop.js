...
return [(function (){var pred__26775 = cljs.core.instance_QMARK_;
var expr__26776 = reactive_val;
if(cljs.core.truth_((pred__26775.cljs$core$IFn$_invoke$arity$2 ? pred__26775.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__26776) : pred__26775.call(null,reagent.ratom.RAtom,expr__26776)))){
return "ra";
} else {
if(cljs.core.truth_((pred__26775.cljs$core$IFn$_invoke$arity$2 ? pred__26775.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__26776) : pred__26775.call(null,reagent.ratom.RCursor,expr__26776)))){
return "rc";
} else {
if(cljs.core.truth_((pred__26775.cljs$core$IFn$_invoke$arity$2 ? pred__26775.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__26776) : pred__26775.call(null,reagent.ratom.Reaction,expr__26776)))){
return "rx";
} else {
if(cljs.core.truth_((pred__26775.cljs$core$IFn$_invoke$arity$2 ? pred__26775.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__26776) : pred__26775.call(null,reagent.ratom.Track,expr__26776)))){
return "tr";
} else {
return "other";
}
