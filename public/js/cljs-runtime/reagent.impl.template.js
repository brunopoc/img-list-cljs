...
var G__26622 = o;
(G__26622[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__26626 = o;
(G__26626[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__26631__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__26632){
...
var props = map__26633__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26633__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.keep.cljs$core$IFn$_invoke$arity$2(((function (map__26633,map__26633__$1,props,class$){
return (function (c){
...
});})(map__26633,map__26633__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__26635){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26636__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render(((function (node_value,map__26636,map__26636__$1,on_write){
return (function (){
...
});})(node_value,map__26636,map__26636__$1,on_write))
);
} else {
...
var G__26639 = jsprops;
(G__26639["defaultValue"] = value);

(G__26639["onChange"] = ((function (G__26639,v,value,on_change){
return (function (p1__26638_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26638_SHARP_);
});})(G__26639,v,value,on_change))
);
...
var vec__26641 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26641,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26641,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26641,(2),null);
...
var jsprops = ({"argv": v});
var temp__5724__auto___26675 = reagent.impl.template.key_from_vec(v);
if((temp__5724__auto___26675 == null)){
} else {
var key_26676 = temp__5724__auto___26675;
...
var temp__5724__auto___26677 = reagent.impl.template.key_from_vec(argv);
if((temp__5724__auto___26677 == null)){
} else {
var key_26679 = temp__5724__auto___26677;
reagent.impl.template.oset(jsprops,"key",key_26679);
}
...
var G__26645 = reagent.impl.template.__GT_NativeWrapper();
(G__26645["name"] = c);
...
var G__26646 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26646) : reagent.impl.template.as_element.call(null,G__26646));
} else {
...
var len__4730__auto___26681 = arguments.length;
var i__4731__auto___26682 = (0);
while(true){
if((i__4731__auto___26682 < len__4730__auto___26681)){
args__4736__auto__.push((arguments[i__4731__auto___26682]));

var G__26683 = (i__4731__auto___26682 + (1));
i__4731__auto___26682 = G__26683;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26649){
var G__26650 = cljs.core.first(seq26649);
var seq26649__$1 = cljs.core.next(seq26649);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__26650,seq26649__$1);
});
...
break;
default:
var G__26689 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__26689;
continue;
...
var n__4607__auto___26690 = a.length;
var i_26691 = (0);
while(true){
if((i_26691 < n__4607__auto___26690)){
(a[i_26691] = reagent.impl.template.as_element((a[i_26691])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4607__auto___26693 = a.length;
var i_26694 = (0);
while(true){
if((i_26694 < n__4607__auto___26693)){
var val_26695 = (a[i_26694]);
if(((cljs.core.vector_QMARK_(val_26695)) && ((reagent.impl.template.key_from_vec(val_26695) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_26694] = reagent.impl.template.as_element(val_26695));

var G__26696 = (i_26694 + (1));
i_26694 = G__26696;
continue;
} else {
}
...
var ctx = ({});
var vec__26653 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26653,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26653,(1),null);
...
var G__26656 = (cljs.core.count(argv) - first_child);
switch (G__26656) {
case (0):
...
case (1):
var G__26657 = comp;
var G__26658 = jsprops;
var G__26659 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__26657,G__26658,G__26659);

break;
default:
return module$node_modules$react$index.createElement.apply(null,cljs.core.reduce_kv(((function (G__26656){
